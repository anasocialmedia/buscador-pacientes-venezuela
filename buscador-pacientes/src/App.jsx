...
const luciani = [
  ...
  mk("Manufo Ariana", "", "37 años", H_LUCIANI, "Quirofano 26/06/26", ""),
  ...
  mk("Curvelo Maria", "", "16 años", H_LUCIANI, "Quirofano 26/06/26", ""),
  mk("Landi Sebastian", "", "7 años", H_LUCIANI, "Quirofano / Pediatría 26/06/26", "Sec: Quirofano y Pediatría"),
  mk("Fernandez Emile", "", "26 años", H_LUCIANI, "Quirofano 26/06/26", ""),
  mk("Bolivar Yoscaili", "", "12 años", H_LUCIANI, "Quirofano 26/06/26", ""),
  ...
  // ── Pediatría 26/06/26 ──
  mk("Ana Lucia Hilders", "", "4 años", H_LUCIANI, "Pediatría 26/06/26", "Proc: La Guaira"),

...
const catia = [
  ...
  mk("Paciente sin nombre legible", "31962237", "20 años", H_CATIA, "Lista impresa 25/06/26", "Sec: Cirugía · Cama #3 · nombre cortado en foto"),
  mk("Luisanyeli Zapata", "30114918", "22 años", H_CATIA, "Lista impresa 25/06/26", "Sec: Cirugía · Cama #10 · Proc: Caracas - Elatillo"),
  mk("Valella Gorrin", "29571733", "24 años", H_CATIA, "Lista impresa 25/06/26", "Sec: Cirugía · Cama #11 · Proc: La Guaira - Playa Grande"),
  mk("Jhonson Estebes", "", "17 años", H_CATIA, "Lista impresa 25/06/26", "Sec: Cirugía · Cama #18 · Proc: La Guaira - Monte Sano"),
  mk("Yeison Blanco", "11557611", "50 años", H_CATIA, "Lista impresa 25/06/26", "Sec: Cirugía · Cama #17 · Proc: Caracas - Catia"),
  mk("Daner Salazar", "", "", H_CATIA, "Lista impresa 25/06/26", "Sec: Cirugía"),
  ...
  mk("Roskel Nieves", "", "30 años", H_CATIA, "Actualización manuscrita", "Dx: Trauma"),
  mk("Deleet Torres", "", "17 años", H_CATIA, "Actualización manuscrita", "Dx: Cirugía"),
  ...
  mk("Plome Bomb", "", "52 años", H_CATIA, "Actualización manuscrita", "Dx: Trauma · nombre ilegible en original"),
  ...
  mk("Zalozar Caroline", "", "", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Yurbely Martins", "", "", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Marx Yepez", "", "6 años", H_CATIA, "Lista manuscrita adicional", "Dx: Pediatría"),
  mk("Yorber Peña", "", "30 años", H_CATIA, "Lista manuscrita adicional", "Dx: Cirugía"),
  mk("Zacaria Alexis", "", "36 años", H_CATIA, "Lista manuscrita adicional", "Dx: Cirugía"),
  mk("González Ana", "", "51 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Rangel Ender", "", "46 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Milagros Linares", "", "30 años", H_CATIA, "Lista manuscrita adicional", "Dx: MI"),
  mk("Kunz Alfredo", "", "45 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Yelitza Garfonia", "", "62 años", H_CATIA, "Lista manuscrita adicional", "Dx: MI"),
  mk("Cordero Jose", "", "46 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Lopez Valeria", "", "28 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Dario Reuben", "", "20 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Maria Yobana", "", "64 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Mejia Yanez", "", "50 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma Schock"),
  mk("Medina Nelson", "", "49 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Leon Karlos", "", "49 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Pico Yenny", "", "54 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Gecen Jhor", "", "42 años", H_CATIA, "Lista manuscrita adicional", "Dx: Medicina Cerro · nombre incierto en original"),
  mk("Chirino Alexandro", "", "21 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Cortez Yunimar", "", "58 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  ...
  mk("Silvera Leonidy", "", "30 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma Schock"),
  ...
  mk("Nateran Valery", "", "7 años", H_CATIA, "Lista manuscrita adicional", "Dx: Pediatría"),
  ...
  mk("Mora Hilario", "", "13 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Garces Rosa Angel", "", "32 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  mk("Hernals Aranza", "", "11 años", H_CATIA, "Lista manuscrita adicional", "Dx: Pediatría"),
  ...
  mk("Carnero Jigney", "", "45 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
  ...
  mk("Chirino Yleini", "", "57 años", H_CATIA, "Lista manuscrita adicional", "Dx: Trauma"),
